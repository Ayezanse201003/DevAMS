              ...
              <div className='d-flex flex-column'>
                ...
                <div className='d-flex flex-wrap fw-bold fs-6 mb-4 pe-2'>
                  ...
                  <a
                    ...
                    className='d-flex align-items-center text-gray-400 text-hover-primary me-5  mb-2'
                  >
                    <KTIcon iconName='phone' className='fs-4 me-1 ms-2' />
                    {user.phone}
                  </a>
                </div>
              </div>
          ...
          <ul className='nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap'>
            ...
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/alumni/account/skills' && 'active')
                }
                to='/alumni/account/skills'
              >
                Skills
              </Link>
            </li>
            ...
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/alumni/account/academics' && 'active')
                }
                to='/alumni/account/academics'
              >
                Academics
              </Link>
            </li>
            ...
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/alumni/account/work' && 'active')
                }
                to='/alumni/account/work'
              >
                Work
              </Link>
            </li>
            ...
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/alumni/account/survey' && 'active')
                }
                to='/alumni/account/survey'
              >
                Survey
              </Link>
            </li>
